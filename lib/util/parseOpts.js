...
const parseOpts = {
   ...
   */
  parseEnvVars: env => env.reduce((envs, e) => { return envs.concat([ '-e', parseOpts.parseHostEnvVars(e) ]) }, []),
   ...
   */
  parseVolumes: volumes => volumes.reduce((vols, v) => { return vols.concat([ '-v', parseOpts.parseHostEnvVars(v) ]) }, []),
