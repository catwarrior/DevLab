...
const output = {
   ...
   */
  success: m => {
    output.log(chalk.bold.green('⦿ ') + chalk.bold(output.renderVars(m)))
  },
  /**
   ...
   */
  warn: m => {
    output.log(chalk.bold.yellow('⦿ ') + chalk.bold(output.renderVars(m)))
  },
  /**
   ...
   */
  error: m => {
    output.log(chalk.bold.red('⦿ ') + chalk.bold(output.renderVars(m)))
  },
  /**
